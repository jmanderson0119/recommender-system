...
impelementation, which fits a Gaussian distribution to the training ratings and samples predicted values for each test pair.
...
number of epochs with which to produce a model of these user-item interactions. The optimization space is amenable to large parameter 
